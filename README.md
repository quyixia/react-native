# React Native [![Build Status](https://travis-ci.org/quyixia/react-native.svg?branch=master)](https://travis-ci.org/quyixia/react-native)  [![npm version](https://badge.fury.io/js/react-native.svg)](http://badge.fury.io/js/react-native)
